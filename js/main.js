/* ============================
    ...
    const expData = {
      despedidas_soltera: {
        ...
        desc: "Juegos, prendas, disfraces y euforia total. Armamos el recorrido ideal para festejar el fin de la soltería con tu grupo de amigas, coreografías y la mejor onda.",
        gallery: despedidasGallery,
        features: ["Capacidad: Hasta 40 pasajeros", "Duración adaptable", "Juegos interactivos y coordinator"],
        extras: ["Show Drag Queen", "Bebidas liberadas", "Shows de personajes divertidos"]
      },
      despedidas_soltero: {
        title: "Despedida de Soltero",
        desc: "El party bus equipado con el mejor sonido e iluminación para una despedida épica. Recorrido a elección, paradas clave y diversión asegurada.",
        gallery: despedidasGallery,
        features: ["Capacidad: Hasta 40 pasajeros", "Duración adaptable", "Juegos interactivos y coordinator"],
        extras: ["Show Drag Queen", "Bebidas liberadas", "Shows de personajes divertidos"]
      },
